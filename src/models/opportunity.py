...
class Opportunity(BaseModel):
    ...
    Attributes:
        ...
        mvp_suggestion_en: 英文MVP建议（产品概要：核心功能+目标用户+变现方式）(v1.3新增)
        ...
        schema_version: 数据模型版本(v1.3: 添加英文MVP建议)
    """
    ...
    class Config:
        json_schema_extra = {
            "example": {
                ...
                "mvp_suggestion_en": "Core Features: 1) AI-powered YouTube thumbnail generator with multiple style templates, 2) One-click batch generation and A/B testing, 3) Click-through rate analytics dashboard. Target Users: YouTube content creators, video marketing teams, MCN agencies. Monetization: Freemium model, Basic free (10/month), Pro $19/month (unlimited + advanced templates), Enterprise $99/month (team collaboration + API).",
